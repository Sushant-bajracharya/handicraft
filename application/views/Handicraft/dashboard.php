...
<link href="<?php echo site_url() ?>css/<?php echo $theme ?>/jquery.desoslide.css" rel="stylesheet" type="text/css" media="screen">
...
<!--popup form style -->
	...
	<link rel="stylesheet" href="<?php echo site_url() ?>css/<?php echo $theme ?>/swipebox.css">
<!--  bootraps js -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js"></script>
    <script src="<?php echo site_url()?>js/<?php echo $theme ?>/js/bootstrap.min.js"></script>
    <script src="<?php echo site_url()?>js/<?php echo $theme ?>/js/jquery.nivo.slider.js"></script> 
