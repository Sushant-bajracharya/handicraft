...
<div class="col-md-12 inner-page">
		 ...
		 <h1 class="heading-title">Room booking</h1>
    ...
    <tr>
	<td><?php echo $check=$_POST['check_in']; ?></td>
	<td><?php echo $out=$_POST['check_out']; ?></td>
	<td><?php echo $room=$_POST['room']; ?></td>
	<td><?php echo $adult=$_POST['adult']; ?></td>
	<td><?php echo $child=$_POST['child']; ?></td>
	<td><?php echo $no_of_room=$_POST['no_of_room']; ?></td>
    </tr>
    </table>
...
?> 
		<form method="post" class="contact-form"  id="register-form" action="" >
			...
			<button class="btn btn-warning btn-style form-control" type="submit" name="submit"  id="submit"  value="Send Message">Book Now</button>
            </div>
